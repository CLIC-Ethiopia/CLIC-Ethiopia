        ...
        {isModalOpen && selectedEvent && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-lg overflow-y-auto max-h-[90vh] relative flex flex-col"
            >
              <button 
                onClick={() => setIsModalOpen(false)}
                aria-label="Close Event Registration"
                className="absolute top-4 right-4 w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors z-10"
              >
                <X className="w-5 h-5" />
              </button>
