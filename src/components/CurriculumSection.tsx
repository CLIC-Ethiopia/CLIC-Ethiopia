...
const CurriculumSection = () => {
  ...
  return (
    <section id="curriculum" className="py-24 bg-gray-50 overflow-hidden" ref={containerRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-white border border-gray-200 shadow-sm text-gray-600">
    ...
    <div className={`flex flex-col md:flex-row items-center gap-8 md:gap-0 ${isEven ? '' : 'md:flex-row-reverse'}`}>
      ...
      <div className="relative z-10 flex-shrink-0">
        <motion.div
          ...
          className="w-16 h-16 rounded-full bg-white border-4 flex items-center justify-center shadow-lg relative"
      ...
      <div className="w-full md:w-1/2 px-4 md:px-12">
        <motion.div
          ...
          className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300"
        >
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-lg font-bold text-gray-900">{stage.productState}</div>
            </div>
          </div>
        </motion.div>
      </div>
